(function () {
  ...
  function setEstimatedDeliveryRange() {
    ...
    var hasUsLocale = localeCandidates.some(function (locale) {
    ...
    var isUnitedStates = resolvedTimeZone
      ? unitedStatesTimeZones.indexOf(resolvedTimeZone) !== -1
      : hasUsLocale;
